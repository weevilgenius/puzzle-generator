 ...
 */
export const TriangleTabGenerator: TabGenerator = {
  addTab(edge: Edge, topology: PuzzleTopology, random: RandomFn) {
    // Configuration for the tab's shape. This determines how "tall" the
    // tab is relative to the length of the edge.
    const tabHeightRatio = 0.2;
...
export default TriangleTabGenerator;
