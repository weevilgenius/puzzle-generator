...
/**
 * Implements a `TopologyGenerator` that uses a Voronoi diagram to create the
 * puzzle's topology. It builds a full half-edge data structure representing the
 * pieces and their connectivity.
 */
export const VoronoiTopologyGenerator: TopologyGenerator = {
  /**
   ...
   * @param options Configuration for generation, including puzzle dimensions.
...
export default VoronoiTopologyGenerator;
