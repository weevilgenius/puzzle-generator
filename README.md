...
The puzzle generation process is broken into four stages (seed points, piece
generation, tab placement, and tab generation), each of which can be extended with
custom algorithms. To add a new point, piece or tab shape, see the
